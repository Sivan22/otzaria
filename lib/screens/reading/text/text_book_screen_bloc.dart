...
import 'package:otzaria/screens/reading/text/commentators_list_screen.dart';
import 'package:otzaria/screens/reading/text/links_screen.dart';
import 'package:otzaria/screens/reading/text/splited_view_screen_bloc.dart';
  ...
  Widget _buildBookmarkButton(BuildContext context, TextBookState state) {
    return IconButton(
      onPressed: () async {
        ...
        final toc = state.book.tableOfContents;
        String ref = await utils.refFromIndex(index, toc);
        // bool bookmarkAdded =
